  ...
  return (
    <>
      <section className="w-full h-screen relative bg-opacity-50 bg-gradient-to-b from-blue-e5e5e583 to-blue-81b8ff85 px-[5%] md:px-[8%] flex flex-col items-center justify-center">
        ...
        <div className="w-3/5 relative bg-blue-ffffff59 rounded-[2.5rem] p-[5%]  mt-[30px] 2xl:mt-[60px]">
          ...
          <form action="" className="w-full  flex flex-col items-center">
            <div className="relative w-full flex flex-col items-center">
              <h1 className="text-base 2xl:text-[2rem] text-[#000000] text-center">
                Login to your account!
              </h1>
              {/* Login accont Logo */}
              <div className="size-[80px] 2xl:size-[140px] rounded-full overflow-hidden relative mt-[20px] 2xl:mt-[50px]">
                <Image src={Icons.Login} width={140} height={140} alt="user" />
              </div>

              {/* Email input  */}
              <div className="w-full max-w-[507px] h-[56px] relative rounded-[28px] mt-[20px] 2x:mt-[50px]">
                <span className="absolute top-1/2 -translate-y-1/2 right-6">
                  <Image src={Icons.Mail} width={20} height={20} alt="Mail" />
                </span>
                <Input
                  classname={"w-full h-full rounded-[28px] bg-blue-d9ecff outline-none px-6 py-[18px] placeholder:text-base placeholder:text-[#787878]"} type="email" placeholder="Enter Email Id"
                />
              </div>
              {/* Password Input */}
              <div className="w-full max-w-[507px] h-[56px] relative rounded-[28px] mt-4">
                ...
                <Input classname={"w-full h-full rounded-[28px] bg-blue-d9ecff outline-none px-6 py-[18px] placeholder:text-base placeholder:text-[#787878]"} type="password" placeholder="Enter Password"/>
              </div>
            </div>
            {/* Submit Button for OTP */}
            <div className="w-full max-w-[507px] h-[56px mt-[40px] 2xl:mt-[80px]">
                <Button textValue="Get OTP"/>
            </div>
          </form>
        </div>
        ...
        {/* popup overlay */}
        <div
          className={`w-full h-full  absolute bg-overlay-00000040 backdrop-blur-sm flex justify-center items-center hidden`}
        >
          {/* OTP POPUP */}
          <div className="w-full max-w-[760px] h-full max-h-[508px] bg-blue-ffffff80 rounded-[40px] px-[2.5rem] flex flex-col items-center gap-[40px] justify-center">
            ...
            <h2 className="text-3xl text-[#000000] text-center">
            ...
            <button className="text-blue-3e91ff text-2xl text-center">
              Resend OTP
            </button>
          </div>
        </div>
